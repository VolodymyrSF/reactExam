    ...
    return (
        <div className={css.detailsDiv} >
            ...
            <div className={css.titleDiv}>{title}</div>
                <StarRatings
                    rating={vote_average / 2} // Ділимо на 2, так як react-star-ratings очікує значення від 0 до 5
                    starDimension="20px" // Задає розмір зірок
                    starRatedColor="orange" // Задає колір зірок
                />
